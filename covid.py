...
df = pd.read_csv('https://covid.ourworldindata.org/data/vaccinations/vaccinations-by-manufacturer.csv',
                 parse_dates=['date'])
...
total_styled = total_df.style.bar(subset=["total_vaccinations"], color='#5fba7d',
